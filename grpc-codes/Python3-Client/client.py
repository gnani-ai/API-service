...
class Sender:
    ...
    def clientChunkStream(self, service, filename, token, accesskey, encoding, lang_code, audioformat, chunkSize=1024):
        ...
        responses = service.DoSpeechToText(request_stream(), _TIMEOUT_SECONDS_STREAM, metadata=(
        ('token', token), ('lang', lang_code), ('accesskey', accesskey), ('audioformat', audioformat),
...
if __name__ == '__main__':
    ...
    """
    1. By default english.wav audio file is considered
    2. Default chunk-size is 1280
    """
